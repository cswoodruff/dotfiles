...
datewidget.width, datewidget.align = 110, "center"
vicious.register(datewidget, vicious.widgets.date, "%b %d, %l:%M %p", 61)

memwidget = widget({ type = "textbox" })
memwidget.width, memwidget.align = 80, "center"
...
netwidget.width, netwidget.align = 100, "center"
vicious.register(netwidget, vicious.widgets.net, "NET ${eth0 up_kb}/${eth0 down_kb}", 1)
...
vicious.register(uptimewidget, vicious.widgets.uptime, "UP $1", 86400)
-- }}}
